...
export function EditLabelTitle({ label, onOpenAddLabelModal, onSaveLabel, onRemoveLabel }) {
    ...
    return (<>
        ...
        <section className="edit-label-modal">
            ...
            <h3 className='small-headline cmp-dynamic-options-title edit-label-modal-mini-title '>Title</h3>
            <input
                type="text"
            ...
            <div className='colors'>
                <h3 className='small-headline cmp-dynamic-options-title  '>Select color</h3>
